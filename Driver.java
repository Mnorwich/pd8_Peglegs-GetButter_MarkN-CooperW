...
public class Driver{
	...
	n.add(new TreeNode (new MPTrivia(), "The old man from scene twenty-four appears.  He is the keeper of the bridge of death.  He asks each traveler three questions, no, five questions.  He who answers the three questions, no, five questions, may cross it safely.  What if you get a question wrong, you ask? You are cast into the gorge of eternal peril.  Answer the three questions, no, five questions, as best you can.  God be with you.", "Right, off you go.  After crossing the bridge of death, you enter the castle.  Here you must choose to (0) go down the left corridor or (1)the right corridor.  What is your choice?")); 
